 ...
 */
public class ElamiteDictHandler extends CuneiDictHandler {
    /**
     ...
     * @param posTagger
     */
    public ElamiteDictHandler(List<String> stopchars, CharTypes charType, POSTagger posTagger) {
        super(stopchars, CharTypes.ELAMITE,new POSTagger(new TreeMap<>(),CharTypes.ELAMITE));
    }
