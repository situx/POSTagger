 ...
 */
public class LuwianCuneiDictHandler extends CuneiDictHandler {
    /**
     ...
     * @param posTagger
     */
    public LuwianCuneiDictHandler(List<String> stopchars, CharTypes charType, POSTagger posTagger) {
        super(stopchars, CharTypes.LUWIANCN, new POSTagger(new TreeMap<>(),CharTypes.LUWIANCN));
    }
