 ...
 */
public class ElamiteCorpusHandler extends CuneiCorpusHandler {
    /**
     * Constructor for this class.
     *
     * @param stopchars stopchars to consider
     */
    public ElamiteCorpusHandler(List<String> stopchars) {
        super(stopchars);
    }
    ...
    public DictHandling getUtilDictHandler() {
        if(this.utilDictHandler==null){
            ...
            try {
                this.utilDictHandler.importMappingFromXML("dict/ela_map.xml");
                this.utilDictHandler.importDictFromXML("dict/ela_dict.xml");
