...
public class ToAkkadTranslator extends Translator {
    ...
    public Translator getTranslator(CharTypes to){
        switch (to){
            ...
            case AKKADIAN: return new TransliterationTranslator(CharTypes.AKKADIAN);
            default:
                return this;
        }
    }
    ...
    public Translator getTranslator(CharTypes to,POSTagger fromPos){
        switch (to){
            case ENGLISH: return new AkkadToEngTranslator(CharTypes.AKKADIAN,fromPos);
            case GERMAN: return new AkkadToGerTranslator(CharTypes.AKKADIAN,fromPos);
            default:
                return this;
        }
    }
