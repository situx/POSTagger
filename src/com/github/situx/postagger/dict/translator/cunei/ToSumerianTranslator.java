 ...
 */
public class ToSumerianTranslator extends Translator {

    public String translate(CharTypes to,String translationText,TranslationMethod translationMethod){
        String result="";
        switch (to){
            case ENGLISH: result=this.sumToEnglish(translationText,translationMethod);
                break;
            default:
        }
        return result;
    ...
    public Translator getTranslator(CharTypes to,POSTagger fromPos){
        String result="";
        switch (to){
            case ENGLISH: return new SumToEngTranslator(CharTypes.SUMERIAN,fromPos);
            case SUMERIAN: return new SumToEngTranslator(CharTypes.SUMERIAN,fromPos);
            default:
                return this;
        }
    }

    public String sumToEnglish(String translationText,TranslationMethod translationMethod){
