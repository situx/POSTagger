...
public class GenericInputMethodDescriptor implements InputMethodDescriptor {
    ...
    public static InputContext context = null;
    ...
    public InputMethod createInputMethod() throws Exception {
        ...
        return new GenericInputMethod<AkkUnit>(new AkkInputTermSource(new TreeBuilder(this.getClass().getClassLoader().getResourceAsStream("ime/akkadian.xml"),GenericInputMethodDescriptor.AKKADIAN)));
    }
