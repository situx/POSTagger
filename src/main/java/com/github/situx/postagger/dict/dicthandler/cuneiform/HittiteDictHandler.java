...
public class HittiteDictHandler extends CuneiDictHandler {
    ...
    public HittiteDictHandler(List<String> stopchars){
        super(stopchars,CharTypes.HITTITE,new POSTagger(new TreeMap<>(),CharTypes.HITTITE));
        this.chartype=CharTypes.HITTITE;
    }
    ...
    public void importDictFromXML(String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        parser.parse(filepath,new AkkadianImportHandler(Options.FILLDICTIONARY,this,this.dictionary,this.translitToWordDict,this.transcriptToWordDict,this.logographmap,CharTypes.HITTITE));
    }
    ...
    public void importMappingFromXML(String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        InputSource is = new InputSource(in);
        is.setEncoding(Tags.UTF8.toString());
        parser.parse(filepath,new AkkadianImportHandler(Options.FILLMAP,this,this.dictmap,this.translitToCharMap,this.transcriptToWordDict,this.logographmap,CharTypes.HITTITE));
    }
    ...
    public void importReverseDictFromXML(final String filepath) throws ParserConfigurationException, SAXException, IOException {
        ...
        InputSource is = new InputSource(in);
        is.setEncoding(Tags.UTF8.toString());
        AkkadianImportHandler imp=new AkkadianImportHandler(Options.REVERSEDICT,this,this.reversedictionary,this.reverseTranslitToWordDict,this.reverseTranscriptToWordDict,this.logographmap,CharTypes.HITTITE);
        parser.parse(in,imp);
        parser.reset();
    }
    ...
    public void parseDictFile(final File file) throws IOException, ParserConfigurationException, SAXException {
        ...
        parser.parse(file, new CuneiSignImportHandler(this.dictmap,this.dictionary,this.translitToCharMap,this.translitToWordDict,this.transcriptToWordDict, CharTypes.HITTITE));
    }
