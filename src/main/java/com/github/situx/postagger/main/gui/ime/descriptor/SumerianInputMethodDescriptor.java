 ...
 */
public class SumerianInputMethodDescriptor implements InputMethodDescriptor {
        public static final Locale SUMERIAN = new Locale("sum", "", "x-sum-latin");

        public SumerianInputMethodDescriptor() {
        ...
        public InputMethod createInputMethod() throws Exception {
            ...
            return new GenericInputMethod<>(new AkkInputTermSource(new TreeBuilder(this.getClass().getClassLoader().getResourceAsStream("ime/sumerian.xml"), GenericInputMethodDescriptor.SUMERIAN)));
        }
